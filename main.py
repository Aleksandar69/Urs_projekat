        ...
        if opcija == 1:
            ...
            while opt != 6:
                ...
                if opt == 1:
                    ...
                    if kolicina <= 0:
                        raise Exception
                    ukupna_cijena = float(input("Unesite ukupnu cijenu: "))
                    if ukupna_cijena <= 0:
                        raise Exception
                    ...
                    print("3 -> Pretraga po ukupnoj cijeni")
                    opt_pretraga = int(input("Unesite pretragu: "))
            ...
            while opt != 7:
                ...
                if opt == 1:
                    ...
                    print("3 -> Pretraga po ukupnoj cijeni")
                    print("4 -> Pretraga po ukupnoj datumu")
                    opt_pretraga = int(input("Unesite pretragu: "))
